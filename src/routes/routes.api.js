...
routerAPI.post(
  "/subboards/:taskId",
  requireAdminRole,
  subboards.addSubBoardToTask
);
routerAPI.patch(
  "/subboards/:subBoardId",
  requireAdminRole,
  subboards.updateSubBoardOnTask
);
routerAPI.delete(
  "/subboards/:subBoardId",
  requireAdminRole,
  subboards.deleteSubBoardOnTask
);
// upload image
routerAPI.post(
  "/subboards/:subBoardId/upload-bg",
  authTokenMiddleWare,
  subboards.uploadSubBoardImage
);
...
routerAPI.get(
  "/tasks/:taskId/comments",
  authTokenMiddleWare,
  comments.getAllCommentsOfATask
);
